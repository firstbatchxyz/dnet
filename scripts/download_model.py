...
def download_model(model_name: str) -> None:
    ...
    Args:
        model_name: Model name or HuggingFace repo ID (e.g., Qwen/Qwen3-4B-MLX-4bit)
    """
    ...
    try:
        ...
        path_result = get_model_path(model_name)
        ...
        if path is None:
            print(f"Error: Could not resolve model path for {model_name}")
            sys.exit(1)
